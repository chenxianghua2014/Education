	...
	<div class="editBlock">
		<form method="post" autocomplete="off"
			...
			<input type="hidden" id="subjectId" name="subjectId"
				...
				name="courseId" value="${ subject.courseId }" /><input
				type="hidden" id="subjectAnswer" name="subjectAnswer"
				value="手动评分" />
			<table>
				<tr>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="hidden" id="subjectType" name="subjectType"
							value="${subject.subjectType}" />填空题<p class="warning">注:需要填写部分请用$()$代替</p></td>
					</tr>
					<tr>
