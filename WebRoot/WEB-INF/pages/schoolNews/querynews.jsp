...
<script type="text/javascript">
	...
	function collectionNewsAll(cj,sort) {
		window.location = "collectionschoolNewsAll?newsSort="+sort+"&cj="+cj+"&page=1";
	}
	
	function stickNews(sjid) {
		window.location = "stickschoolNews?id="+sjid+"&mark=1";
	}
...
function editNew(newsId) {
	window.location = "schoolnewsSkipID?id=" + newsId+"&mark=1&newsType=3";
}
...
<body>
	<div class="title">当前位置:党校管理>党校新闻管理</div>
	<div class="editBlock">
		
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">党校新闻管理</td>
				</tr>
				<tr>
