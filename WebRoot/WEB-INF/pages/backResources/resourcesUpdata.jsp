...
<body>
	...
	<div class="editBlock">
		<form action="UpdataResources" method="post" autocomplete="off"  id="fff"   name="fff" 
			data-validator-option="{theme:'yellow_right_effect',stopOnError:true} " enctype="multipart/form-data">
			<input type="hidden" name="knowledgeId"  id="knowledgeId"  value="${knowledge.knowledgeId}"/>
			<input type="hidden" name="knowledgePath"  id="knowledgePath" value="${knowledge.knowledgePath }" />
			<table>
				<tr>
				...
				<tbody>
					<tr >
						...
						<td><input id="knowledgeName" name="knowledgeName" type="text" class="inputText" style="width:300px;"  value="${knowledge.knowledgeName }"  data-rule="required;"/></td>
					</tr>
					<tr >
						<th width="150">制作人:</th>
						<td><input id="knowledgeProducer" name="knowledgeProducer" type="text" class="inputText" style="width:300px;"  value="${knowledge.knowledgeProducer }"  data-rule="required;"/></td>
					</tr>
					<tr>
							<th width="150">
								文件支持下载 
							...
							<td>
								<select name="knowledgeCatalog" id="knowledgeCatalog"  data-rule="required;">
									<option value="1" ${knowledge.knowledgeCatalog=="1"?"selected":"" }>
										是
									</option>
									<option value="2" ${knowledge.knowledgeCatalog=="2"?"selected":"" }>
										否
									</option>
									</select>
							</td>
