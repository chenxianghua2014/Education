...
function editNew(newsId) {
	window.location = "newsSkipID?id=" + newsId+"&mark=1&newsType=2";
}
...
<body>
	<div class="title">当前位置:信息管理>滚动新闻管理</div>
	<div class="editBlock">
		
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">滚动新闻管理</td>
				</tr>
				<tr>
