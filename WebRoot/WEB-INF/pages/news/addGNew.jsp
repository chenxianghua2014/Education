...
<input type="hidden" id="purl1" name="newsSort" value="<%=request.getSession().getServletContext().getRealPath("/")%>" /> 
	<div class="title">当前位置:滚动新闻管理>编辑滚动新闻</div>
	<div class="editBlock">
		<form action="newSava" method="post" id="fff" class="registerform"  name="fff">
			<input type="hidden" id="organizationId" name="organizationId" value="${sjid}" /> 
			<input type="hidden" id="newsRank" name="newsRank" value="${rank}" /> 
			<input type="hidden" id="newsSort" name="newsSort" value="2" /> 
			<table>
				<tr>
					<td colspan="2" class="subtitle">编辑滚动新闻信息</td>
				</tr>
				<tbody>
					...
					<th width="150"></th>
	                   ...
	                   <!--<img src="./UploadFile/YYZZ/a34d7e214d7b4304b900d1b2514db52e.jpg" style="border:1px solid #000;height: 200px;width:200p\"/>  -->
							<input  id="newsImage"  name="newsImage" type="file" /> <font color="Red">注意：请上传小于800K的图片</font>
	   			            <input  id="newsImages" name="newsImage" type="hidden"  value="" />
	             ...
	             if (a!="") {
					...
					<tr>
						...
						<!-- <textarea id="editor_id" name="newsContent" style="width:600px;height:320px;" ></textarea> -->
                         <textarea id="TxtFile" name="newsContent"   style="width:1000px;height:320px;"></textarea>
                          <!--   <input type="hidden" id="hidTxtFile" name="hidTxtFile" />  -->
