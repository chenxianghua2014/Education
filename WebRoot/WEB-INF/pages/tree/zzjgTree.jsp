...
if(type == '新闻'){
		window.parent.document.getElementById('rightMain').src="journalism?newsSort=1&mark=1&organizationId="+n+"&page=1&cj="+i;
		//window.parent.document.getElementById('rightMain').src="journalism";
	}
	if(type == '通知'){
		window.parent.document.getElementById('rightMain').src="NoticeAll?noticeSort=1&mark=1&organizationId="+n+"&page=1&cj="+i;
	}
	if(type == '计划'){
		window.parent.document.getElementById('rightMain').src="programmeAll?programmeSort=1&mark=1&organizationId="+n+"&page=1&cj="+i;
	}
}
