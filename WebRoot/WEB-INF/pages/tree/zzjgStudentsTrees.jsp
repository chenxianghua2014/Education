...
function open_list(n,type,i) {
	if(type == '部门'){
		window.parent.document.getElementById('rightMain').src="DepartmentAll?mark=1&organizationId="+n+"&page=1&cj="+i;
		//window.parent.document.getElementById('rightMain').src="journalism";
	}
	if(type == '学员'){
		window.parent.document.getElementById('rightMain').src="studentxyht?mark=1&organizationId="+n+"&page=1&cj="+i;
	}
}
