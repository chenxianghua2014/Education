...
<body>
	<div class="title">当前位置:学员管理>部门</div>
	<div class="editBlock">
			...
			<tbody>
				...
				<tr>
					<td style="text-align: left"><input name="button" type="button"
						class="inputButton" value="添加"  onclick="Addnew('${notice.organizationId}','${cj}')"/>
						<input name="button" type="button"
						class="inputButton" value="切换收藏"  onclick="collectionNoticeAll('${cj}')"/>
					</td>
						
					<td style="text-align: right;">
					<form action="NoticeAll?mark=1&page=1&cj=${cj}" method="post"  >
					发布级别:<select
		...
		<table>
			...
			<tbody id="">
				...
				<%-- 	<td>${status.count}</td> --%>
					...
					<td class='alignCenter'><input name='button'type='button' onclick="editNew('${maps.noticeId}')" class='inputButton' value='编辑' /></td>
