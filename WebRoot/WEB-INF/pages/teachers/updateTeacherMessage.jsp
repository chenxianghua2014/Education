...
<script type="text/javascript" src="js/uploadTeacher_pic.js"></script>
<!-- 日期 -->
...
<input type="hidden" id="purl1" name="newsSort" value="<%=request.getSession().getServletContext().getRealPath("/")%>" /> 
	...
	<div class="editBlock">
		<form action="teacherUpdateSave" method="post" id="teacherForm" autocomplete="off" name="teacherForm"
			...
			<input type="hidden" id="teacherRank" name="teacherRank" value="${teacher.teacherRank}" /> 
			<input type="hidden" id="teacherCatalog" name="teacherCatalog" value="${teacher.teacherCatalog}" /> 
			...
			<table>
				...
				<tbody>
					...
					<tr >
						...
						<td><input id="teacherName" name="teacherName" value="${teacher.teacherName}" type="text" class="inputText" style="width:300px;"   data-rule="required;"/></td>
					</tr>
					<tr>
						<th width="150">教师年龄:</th>
						<td><input id="teacherAge" name="teacherAge" value="${teacher.teacherAge}" type="text" class="inputText" style="width:300px;"   data-rule="required;"/></td>
					</tr>
					<tr>
					<th width="150">教师照片</th>
	                   ...
	                   <!--<img src="./UploadFile/YYZZ/a34d7e214d7b4304b900d1b2514db52e.jpg" style="border:1px solid #000;height: 200px;width:200p\"/>  -->
							<input  id="newsImage"  name="teacherPhoto" type="file" /> <font color="Red">注意：请上传小于800K的图片</font>
	   			            <input  id="newsImages" name="teacherPhoto" type="hidden"  value="${teacher.teacherPhoto}" />
				             <div id="myTargetDivPic">
				              <img src="./${teacher.teacherPhoto}" style="border:1px solid #000;height: 185px;width:330px"/>
	      ...
	      /*        var a=document.getElementById('newsImages').value; 
	             if (a!="") {
					...
					<tr>
					     <th width="150">简历:</th>
						<td>
						<%-- <textarea id="editor_id" name="teacherInformation" style="width:600px;height:320px;" >${teacher.teacherInformation}</textarea> --%>
                         <textarea id="TxtFile" name="teacherInformation"   style="width:700px;height:320px;" >${teacher.teacherInformation}</textarea>  
                          </td>
					</tr>
				...
				<tr>
						...
						<td><input id="teacherAdmin" name="teacherAdmin" value="${teacher.teacherAdmin}" type="text" class="inputText" style="width:300px;"  data-rule="required;"/></td>
					</tr>
