	...
	<div class="concainer">
        <div class="video_page">
            ...
            <div class="video_xiangQ" style="position: relative">
            	...
            	<input name="button" type="button" class="inputButton" value="收藏"  onclick="collectOne('${courseId}')" style="width:50px; height:30px; background: #0c5daa; color:#fff;border-radius:5px"/>
            </div>
			...
			<div class="video_page_dagang">
                ...
                <div>
					<ul>
                    	...
                    	<c:if test="${c.courseresourceMark == '1'}">
						...
						<c:if test="${c.courseresourceMark != '1'}">
						<li><span class="dagang_title01">${c.courseresourceName} </span><span class="dagang_title02">${c.courseresourceFiletype }</span><span class="dagang_title03">停用</span></li>
						</c:if>
						</c:if>
                        </c:forEach>
                   </ul>	
    ...
    $(function() {
	      if(estimatePoint==""){
		        ...
		        click: function(score, evt) {
		        	var url="webEstimate?id=" + courseId+"&coursestudyId="+coursestudyId+"&tpk=1&score="+score;
		          window.location = url;
			        }
			      });    
		    }else{
