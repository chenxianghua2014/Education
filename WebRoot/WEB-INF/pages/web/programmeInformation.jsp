...
<div class="main">
	<div class="concainer">
    	<div class="training_dynamic">
			...
			<c:if test="${tpk==1 }">
			<a href="noticeInfoAll?mark=3&page=1&sort=1&oid=test001" style="color:#005BAC;">培训计划</a>&nbsp;>>&nbsp;计划详情
			</c:if>
			<c:if test="${tpk==2 }">
			<a href="SchoolnoticeInfoAll?mark=3&page=1&sort=2&oid=test001" style="color:#005BAC;">学习计划</a>&nbsp;>>&nbsp;计划详情
			</c:if>
			</div>  
        </div>
        <div class="trainiing_news">
        	<div class="news_details_title" style="color: rgb(0, 129, 255);">&nbsp;&nbsp;<h2>${programme.programmeName}</h2></div>
            <div class="news_details_time">
            时间:${programme.programmeTime}  &nbsp;&nbsp;发布单位 : ${programme.organization.organizationDwmc}  &nbsp;&nbsp;字体 ：
				【<a class="b" 
