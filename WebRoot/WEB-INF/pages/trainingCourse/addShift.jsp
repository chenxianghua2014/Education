...
<body>
	...
	<div class="editBlock">
		<form action="shiftSava" method="post" id="fff" class="registerform" name="fff" >
			<input type="hidden" id="classresourceId" name="classresourceId" value="${pageShiftId}" />
			<input type="hidden" id="tranclassRank" name="tranclassRank" value="${cj}" />
			<input type="hidden" id="tranclassCategroy" name="tranclassCategroy" value="${pageLb}" />
			...
			<table>
				...
				<tbody>
					<tr >
						...
						<td><input id="tranclassName" name="tranclassName" type="text" class="inputText" style="width:300px;"  value="" value="" datatype="*" errormsg="不能为空！"/></td>
					</tr>
					 <tr >
						<th width="150">班主任:</th>
						<td><input id="tranclassTeacher" name="tranclassTeacher" type="text" class="inputText" style="width:300px;"  value=""  value="" datatype="*" errormsg="不能为空！"/></td>
					</tr>
					<tr >
						<th width="150">开设时间:</th>
						<td><input type="text" name="tranclassSetuptime" class="inputText" id="tranclassSetuptime"  value="" onclick="WdatePicker({ minDate:'#tranclassEndtime' })" value="" datatype="*" errormsg="不能为空！"/></td>
					</tr>
					<tr >
						<th width="150">结束时间:</th>
						<td><input type="text" name="tranclassEndtime" class="inputText" id="tranclassEndtime"  value="" onclick="WdatePicker({minDate:'#F{$dp.$D(\'tranclassSetuptime\')}'})" value="" datatype="*" errormsg="不能为空！"/></td>
					</tr>
				<!-- 	<tr >
					...
					<tr>
						...
						<td>
						<!-- <textarea id="editor_id" name="tranclassDetails" style="width:600px;height:320px;" value="" datatype="*" errormsg="不能为空！"></textarea> -->
                         <textarea id="TxtFile" name="tranclassDetails"   style="width:700px;height:320px;" datatype="*" errormsg="不能为空！"></textarea>
                          </td>
					</tr>
				</tbody>
				<tr>
