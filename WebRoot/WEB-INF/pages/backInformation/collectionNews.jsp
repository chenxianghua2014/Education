...
<script type="text/javascript">
	function Addnew(sjid,cj) {
		window.location = "newsSkipID?id=0";
	}
	
	function collectionNewsAll(cj) {
		window.location = "collectionNewsAll?cj="+cj+"&page=1";
	}
	
	function stickNews(sjid) {
		window.location = "stickNews?id="+sjid+"&mark=0";
	}
...
function editNew(newsId) {
	window.location = "newsSkipID?id=" + newsId+"&mark=0&newsType=1";
}
...
<body>
	<div class="title">当前位置:信息管理>新闻收藏</div>
	<div class="editBlock">
		
		<table>
			<tbody>
				<tr>
					<td height="32" colspan="4" class="subtitle">新闻收藏</td>
				</tr>
			</tbody>
		</table>
