...
<body>
	<div class="title">当前位置:新闻管理>编辑新闻</div>
	<div class="editBlock">
		<form action="newSava" class="registerform"  method="post" id="fff"  name="fff">
			<input type="hidden" id="organizationId" name="organizationId" value="${sjid}" /> 
			<input type="hidden" id="newsRank" name="newsRank" value="${rank}" /> 
			<input type="hidden" id="newsSort" name="newsSort" value="1" /> 
			<table>
				<tr>
					<td colspan="2" class="subtitle">编辑新闻信息</td>
				</tr>
				<tbody>
				<tr >
					...
					<tr>
						...
						<!-- <textarea id="editor_id" name="newsContent" style="width:600px;height:320px;" datatype="*" errormsg="不能为空！"></textarea> -->
